...
class ResUsersInherit(models.Model):
    ...
    review_ids = fields.Many2many(string='Reviews', comodel_name='tier.review', copy=False)
    ...
    def review_user_count(self):
        ...
        review_groups = self.env['tier.review']._read_group(domain=domain, groupby=['model'],
